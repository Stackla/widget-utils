...
import { loadProductsSwiper } from "./products.swiper"
import { waitForElm } from "../../libs"
import { type SwiperType as Swiper } from "../../types"
...
interface ExpandedTileSettings {
  ...
  swiperSettings?: SwiperTypeOptions
}
...
function initializeSwiperForExpandedTiles(
  ...
  const isStory = expandedTileWrapper.getAttribute("variation") === "vertical"
